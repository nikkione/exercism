...
class AnnalynsInfiltration
{
    ...
    public function canLiberate(
        ...
        return (!$is_archer_awake && $is_dog_present) || ($is_prisoner_awake && !$is_archer_awake && !$is_knight_awake);
    }
}

/*
 * Booleans
The bool type (short for boolean) has only two values -- true and false. The true and false literal values are case insensitive in code.
...
Caution
There is an and and or operator and they are complementary to && and || respectively. They do not have the same behaviour as && and || and may produce unexpected results, and as such their use is discouraged.
