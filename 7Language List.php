...
function add_to_language_list ($arr, $item) {
    array_push($arr, $item);
    return $arr;
}
...
Modify the language_list function, so it takes a variadic argument or string languages. It should return the resulting list with the languages in the list.
